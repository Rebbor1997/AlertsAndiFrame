...
public class TestCasePage extends BasePage {
    ...
    private final static By tab_Test_Suite = By.id("navigation-suites");
    private final static By tab_Test_Runs= By.xpath("//a[.='Test Runs']");
    private final static By tab_Section_Cases= By.id("navigation-suites-sectionscases");
    ...
    public WebElement getTabSuiteAndCases() {return driver.findElement(tab_Test_Suite);}
    public WebElement getTestRuns() {return driver.findElement(tab_Test_Runs);}
    public WebElement getSectionAndCases() {return driver.findElement(tab_Section_Cases);}
    ...
    public void clickTabSuiteAndCases(){ getTabSuiteAndCases().click() ;}
    public void clickTestRuns(){ getTestRuns().click() ;}
    public void clickSectionAndCases(){ getSectionAndCases().click() ;}
